...
class WatchDog extends Eloquent{
	...
	{
		return WatchDog::where('customer_id', $customer_id)
	...
	public static function runningInScheme($scheme_number = null)
	{
		...
		$last_watchdog = WatchDog::where('scheme_number', $scheme_number)->orderBy('id', 'DESC')->first();
	...
	public static function unconfirmedWatchDog($pmd)
	{
		...
		$unconfirmedWatchDog = WatchDog::where('permanent_meter_id', $pmd)->orderBy('id', 'ASC')->where('operator_viewed', false)->first();
	...
	public static function watchDogCompleted($pmd)
	{
		...
		$wd = WatchDog::where('permanent_meter_id', $pmd)->orderBy('id', 'ASC')->where('operator_viewed', false)->first();
