...
class SMSMessagePreset extends Eloquent{
	...
	public function getPresets() {
		return SMSMessagePreset::where('category', $this->category)->get();
	}
	
	public static function categories() {
		return SMSMessagePreset::groupBy('category')->orderBy('id')->get();
	}

	public static function getCategoryPresets($category, $customer_id) {
		
		$presets = SMSMessagePreset::where('category', $category)->get();
