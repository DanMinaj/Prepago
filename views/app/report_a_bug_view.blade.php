					...
					<div class="row">
						 <div class="span8">
							...
							<div class="row">
								...
								<label for="premium" style='font-size:0.9rem;display:inline-block;'>Charge Premium (&euro;.0.25)</label>
								</div>
							</div>
							...
							<div class="row">
								...
								<label for="normal" style='font-size:0.9rem;display:inline-block;'>Charge (&euro;0.08)</label>
								</div>
							</div>
