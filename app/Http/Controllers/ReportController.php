...
class ReportController extends BaseController {
	...
	public function supply_report_units()
	{
		...
		$this->layout->page = View::make('report/supply_report_units', array('customers' => $customers, 'total_usage' => $totalKWhUsage, 'csv_url' => $csv_url, 'from' => $from, 'to' => $to));
	}
	...
	public function search_supply_report_units()
	{
		...
		$this->layout->page = View::make('report/supply_report_units', array('customers' => $customers, 'total_usage' => $totalKWhUsage, 'csv_url' => $csv_url));
	}
	...
	public function pending_topups()
	{
		...
		$this->layout->page = View::make('report/customer_pending_topups', array('customers' => $customers, 'total_amount' => $total_amount, 'csv_url' => $csv_url));
	...
	public function system_topup_history()
	{
		...
		$this->layout->page = View::make('report/customer_topup_history', array('customers' => $customers, 'total_amount' => $total_amount, 'csv_url' => $csv_url));
	}
	...
	public function customer_topup_history_search_by_date()
	{
		...
		$payments = PaymentStorage::where('scheme_number', Auth::user()->scheme_number)->whereBetween('time_date', array($from, $to))->orderBy('time_date', 'DESC')->get(['ref_number', 'customer_id', 'time_date', 'amount', 'currency_code', 'acceptor_name_location', 'acceptor_name_location_']);
		...
		$this->layout->page = View::make('report/customer_topup_history', array(
			'from' => $from, 
			'to' => $to, 
			'overload' => false, 			
			'payments' => $payments, 
	...
	public function tarrif_history()
	{
		...
		$this->layout->page = View::make('report/tarrif_history_view', array('tarrifs' => $tarrifs, 'total_amount' => $total_amount, 'csv_url' => $csv_url));
	}
	...
	public function barcode_reports()
	{
		...
		$this->layout->page = View::make('report/barcode_reports', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function sms_messages()
	{
		...
		$this->layout->page = View::make('report/sms_messages', array('customers' => $customers, 'sms_count' => $sms_count, 'total_amount' => number_format((float)$total_amount, 2, '.', ''), 'csv_url' => $csv_url));
	}
	...
	public function in_app_messages()
	{
		...
		$this->layout->page = View::make('report/in_app_messages', array('customers' => $customers, 'sms_count' => $sms_count, 'total_amount' => number_format((float)$total_amount, 2, '.', ''), 'csv_url' => $csv_url));
	}
	...
	public function names_notes()
	{
		...
		$this->layout->page = View::make('report/customer_name_notes_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function names_mobile_numbers()
	{
		...
		$this->layout->page = View::make('report/customer_name_mobile_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function name_address()
	{
		...
		$this->layout->page = View::make('report/customer_name_address_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function names()
	{
		...
		$this->layout->page = View::make('report/customer_name_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function total_balance()
	{
		...
		$this->layout->page = View::make('report/total_balance_view', array('balance' => $balance, 'csv_url' => $csv_url));
	}
	...
	public function list_of_credit_user()
	{
		...
		$this->layout->page = View::make('report/credit_user_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function list_of_debit_user()
	{
		...
		$this->layout->page = View::make('report/debit_user_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function deposit_reports()
	{
		...
		$this->layout->page = View::make('report/deposit_reports_view', array('customers' => $customers, 'deposite_count'=> $deposite_count, 'total_amount' => $total_amount, 'csv_url' => $csv_url));
	}
	...
	public function iou_usage_display()
	{
		...
		$this->layout->page = View::make('report/iou_usage_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function iou_extra_usage_display()
	{
		...
		$this->layout->page = View::make('report/iou_extra_usage_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function adminIssuedCredit()
	{
		...
		$this->layout->page = View::make('report/admin_issued_credit_view', array('customers' => $customers, 'csv_url' => $csv_url));
	}
	...
	public function bill_reports()
	{
		...
		{		
			if($to && $from)
				$paymentsCollection = PaymentStorage::where('customer_id', $customer->customer_id)->whereBetween('time_date', array($from, $to))->get(['time_date', 'amount', 'currency_code']);
			else
		...
		try {
			...
			foreach($customers as $c) {
				...
				if($actual_usage > $computed_usage) {
					...
					$p->save();
				} else if($actual_usage < $computed_usage){
