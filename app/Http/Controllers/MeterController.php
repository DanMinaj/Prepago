...
class MeterController extends BaseController {
	...
	public function installed_meters()
	{
		...
		$this->layout->page = View::make('meter/list_meters', array(
			'meters' 		=> $meters,
	...
	public function search_installed_meters()
	{
		...
		$this->layout->page = View::make('meter/list_meters', array('meters' => $meters));
	}
	...
	public function meter_data($meter_id)
	{
		...
		$this->layout->page = View::make('meter/meter_data', array('meter' => $meter, 'readings' => $readings, 'abb' => $abb['unit_abbreviation'] ));
	}
