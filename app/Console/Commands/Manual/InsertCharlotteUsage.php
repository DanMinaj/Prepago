...
class InsertCharlotteUsage extends Command
{
     ...
     * @var string
     */
    protected $name = 'insert_usage:charlotte';
     ...
     * @var string
     */
    protected $description = 'Insert usage for missed charlotte customers into district_heating_usage';
    ...
    {
        parent::__construct();
        $this->log = new Logger('Insert Charlotte District Usage');
        ...
        foreach ($charlotteCustomers as $c) {
            ...
            while ($current_date != $end_date) {
                ...
                */
                ...
                $this->info("\n");
                $this->info('Charlotte Customer: #'.$c->id);
