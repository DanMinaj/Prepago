...
class Email extends Eloquent{
	...
	public function send()
	{
		...
		$sender = $this->sender;
		 ...
		 return Mail::send(array(), array(), function($message) use ($body, $title, $to, $from, $sender) {
	...
	{
        return Mail::send(array(), array(), function($message) use ($msg_i, $title_i, $to_i, $from_i, $sender_i) {
	...
	public static function admins($title, $msg)
	{
		...
		Email::quick_send($msg, $title, $admins, "info@prepago.ie", "Prepago System Monitor");
