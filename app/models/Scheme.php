...
->count() == PermanentMeterData::where('scheme_number', $this->scheme_number)->count());		
	...
	///	$stripe_invoices = StripeCustomerSubscription::APIInvoiceTotal($start_date, $end_date);
		...
		$s->sms_total_inc_vat = $sms_cost * Scheme::getSMSCost($s->scheme_number, $start_date, $end_date);
		$s->sms_total_ex_vat = ($s->sms_total_inc_vat/$s->remove_vat);
		$s->premium_sms_total_ex_vat = $premium_sms_cost * Scheme::getPremiumSMSCost($s->scheme_number, $start_date, $end_date);
		...
		$s->blue_accounts = Scheme::getBlueAccounts($s->scheme_number, $start_date, $end_date);
