...
class SupportIssue extends Eloquent{
	...
	public function getCustomerLinkAttribute()
	{
		...
		if($customer) return URL::to('customer_tabview_controller/show', ['customer_id' => $customer->id]);
	...
	public function getSchemeAttribute()
	{
		...
		if($scheme) return $scheme->company_name;
