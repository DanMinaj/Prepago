...
class Stripe
{
	...
	**/
	...
	{
		if(Stripe::$mode == "test") {
			\Stripe\Stripe::setApiKey(Stripe::$secretTestKey);
		} else {
			\Stripe\Stripe::setApiKey(Stripe::$secretLiveKey);
		}
	...
	public static function getPlans()
	{
		...
		if(count($return) == 0) {
			$new_plan = Stripe::createPlan("SnugZone Autopup", "snugzone_1", 3, "Monthly");
			return Stripe::getPlans();
		}
