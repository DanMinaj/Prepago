...
<table width="100%">
	<tr>
		<td width="10%">
			<h4> New Billing Engine</h4>
		</td>
		<td width="10%">
			<h4> Old Billing Engine</h4>
		</td>
		<td width="10%">
	...
	<tr>
		<td>
			<input name="new_billing_engine" type="checkbox" @if($enabled->value == 'true') checked='true' @else @endif data-toggle="toggle" data-onstyle="primary">
		</td>
		<td>
			<input name="old_billing_engine" type="checkbox" @if($old_enabled) checked='true' @else @endif data-toggle="toggle" data-onstyle="primary">
		</td>
		<td>
