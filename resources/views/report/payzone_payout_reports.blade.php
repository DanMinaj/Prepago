...
<div><br/></div>
<h1>Payzone Payout reports</h1>
<div style="float: right">

    <form method="get" action="<?php echo URL::to('system_reports/payzone_payout_reports') ?>"class="form-inline" style="float:left">
...
<div class="admin2">
    ...
    <a href="{{ URL::to('system_reports') }}">System Reports</a> > Payzone Payout reports
    <h3><a href="">
