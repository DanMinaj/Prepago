...
<div style="width:50%;">
   ...
   <table style='' width="100%">
      <tr>
         <td width='40%' style="vertical-align:middle">
            <img @if($fullscreen) src='https://www.snugzone.biz/images/logo.png' @else src='https://www.snugzone.biz/images/logo.png' @endif>
         </td>
   ...
   <table width='100%'>
      <tr>
         <td width='70%' style='text-align: center;'>
            <font style='font-size:1.5rem;font-weight:bold;'>Advice Note</font>
         </td>
         <td width='60%'>
            <div style='text-align:right;font-size:1rem;font-weight:bold;'>
   ...
   <table width='100%'>
      <tr>
         <td width='70%' style='text-align: center;'>
            <font style='font-size:1.5rem;font-weight:bold;'>Invoice</font>
         </td>
         <td width='60%'>
            <div style='text-align:right;font-size:1rem;font-weight:bold;'>
               {!! nl2br($s->company_address) !!}<br/>
   ...
   <div style='position:fixed;
      ...
      bottom:0px;
      height:30px;
      width:100%;font-size:1rem;text-align:right;'>
